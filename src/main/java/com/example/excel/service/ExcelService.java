...
public class ExcelService {
    ...
    public Workbook createExcel(Schedule schedule) {
        ...
        for (YearMonth month : schedule.getData().keySet()) {
            ...
            createReservationHeaderRow(sheet, headerRow, reservationsTimeList);
    ...
    private static void createReservationHeaderRow(Sheet sheet, Row headerRow, List<String> reservationsTimeList) {
